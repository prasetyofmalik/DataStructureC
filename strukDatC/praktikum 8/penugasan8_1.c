...
int main(){
    ...
    enqueue(&wakil, "Wowo", 60,20);
    enqueue(&wakil, "Ame", 60,30);
    enqueue(&wakil, "Walter", 99, 100);
    enqueue(&wakil, "Lester", 95, 70);
    enqueue(&wakil, "Skyler", 80, 90);

    printf("Daftar Perwakilan Mahasiswa Terpilih Mengikuti Lomba Pemrograman\n\n");
